...
Read `.claude/skills/foodcosting-carousel-skill/references/brand-constitution.md` before starting. All color, type, and voice rules live there. This skill defines the current Minimal Editorial carousel system used by the Remotion `Carousel` composition.
